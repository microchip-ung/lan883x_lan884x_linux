...
------------------------------------- 
	...
	Copy and overwrite linux-5.10.155/drivers/net/ethernet/microchip/lan743x_main.c
	Copy and overwrite linux-5.10.155/include/linux/micrel_phy.h
	Copy and overwrite linux-5.10.155/drivers/net/phy/micrel.c
        Delete object files if that exists.
          rm drivers/net/ethernet/microchip/lan743x_main.o
          rm drivers/net/phy/micrel.o
    c. Compile drivers at the root of your linux-5.10.155 source tree.
...
5.  Release history 
-------------------
    v1.0 (public release) 2/14/2023 - internal release on 12/16/2022

6. Known Issues 
---------------------------- 
    TODO: SQI uAPI supports only one pair but the lan8841 supports 4 pairs.
    So far, the micrel.c has TODO code and just returns result for the first pair.
