...
static int ksz9031_config_init(struct phy_device *phydev)
{
	...
	if (of_node) {
		...
		/* Sometimes even if the jumpers on the modules set the phy to
		 * GMII/MII mode this is not set.
		 */
		if (phydev->interface == PHY_INTERFACE_MODE_GMII ||
		    phydev->interface == PHY_INTERFACE_MODE_MII) {
			u16 val;

			phy_write(phydev, MII_MMD_CTRL, 0x2);
			phy_write(phydev, MII_MMD_DATA, 0x3);
			phy_write(phydev, MII_MMD_CTRL, 0x8002);
			val = phy_read(phydev, MII_MMD_DATA);
			/* Check if actually the device is in GMII/MII mode, if
			 * not then overwrite the strap mode
			 */
			if (!(val & BIT(1))) {
				phy_write(phydev, MII_MMD_CTRL, 0x2);
				phy_write(phydev, MII_MMD_DATA, 0x2);
				phy_write(phydev, MII_MMD_CTRL, 0x8002);
				phy_write(phydev, MII_MMD_DATA, 0x2);
			}
		}
...
#define LAN8814_LATENCY_ENABLE				0xf
				 ...
				 int page, u32 addr)
{
	...
	__phy_write(phydev, LAN8814_EXT_PAGE_ACCESS_CONTROL, page);
	__phy_write(phydev, LAN8814_EXT_PAGE_ACCESS_ADDRESS_DATA, addr);
	__phy_write(phydev, LAN8814_EXT_PAGE_ACCESS_CONTROL,
		    (page | LAN8814_EXT_PAGE_ACCESS_CTRL_EP_FUNC));
	data = __phy_read(phydev, LAN8814_EXT_PAGE_ACCESS_ADDRESS_DATA);
				  ...
				  int page, u16 addr, u16 val)
{
	...
	val = __phy_write(phydev, LAN8814_EXT_PAGE_ACCESS_ADDRESS_DATA, val);
	if (val != 0)
...
static int lan8814_rev_workaround(struct phy_device *phydev)
{
	...
	lan8814_write_page_reg(phydev, 28, LAN8814_POWER_MGMT_MODE_3_ANEG_MDI,
			       LAN8814_POWER_MGMT_VAL1_);
	lan8814_write_page_reg(phydev, 28, LAN8814_POWER_MGMT_MODE_4_ANEG_MDIX,
			       LAN8814_POWER_MGMT_VAL1_);
	lan8814_write_page_reg(phydev, 28, LAN8814_POWER_MGMT_MODE_5_10BT_MDI,
			       LAN8814_POWER_MGMT_VAL1_);
	lan8814_write_page_reg(phydev, 28, LAN8814_POWER_MGMT_MODE_6_10BT_MDIX,
			       LAN8814_POWER_MGMT_VAL1_);
	lan8814_write_page_reg(phydev, 28, LAN8814_POWER_MGMT_MODE_7_100BT_TRAIN,
			       LAN8814_POWER_MGMT_VAL2_);
	lan8814_write_page_reg(phydev, 28, LAN8814_POWER_MGMT_MODE_8_100BT_MDI,
			       LAN8814_POWER_MGMT_VAL3_);
	lan8814_write_page_reg(phydev, 28, LAN8814_POWER_MGMT_MODE_9_100BT_EEE_MDI_TX,
			       LAN8814_POWER_MGMT_VAL3_);
	lan8814_write_page_reg(phydev, 28, LAN8814_POWER_MGMT_MODE_10_100BT_EEE_MDI_RX,
			       LAN8814_POWER_MGMT_VAL4_);
	lan8814_write_page_reg(phydev, 28, LAN8814_POWER_MGMT_MODE_11_100BT_MDIX,
			       LAN8814_POWER_MGMT_VAL5_);
	lan8814_write_page_reg(phydev, 28, LAN8814_POWER_MGMT_MODE_12_100BT_EEE_MDIX_TX,
			       LAN8814_POWER_MGMT_VAL5_);
	lan8814_write_page_reg(phydev, 28, LAN8814_POWER_MGMT_MODE_13_100BT_EEE_MDIX_RX,
			       LAN8814_POWER_MGMT_VAL4_);
	lan8814_write_page_reg(phydev, 28, LAN8814_POWER_MGMT_MODE_14_100BTX_EEE_TX_RX,
			       LAN8814_POWER_MGMT_VAL4_);

	/* Refresh time Waketx timer */
	lan8814_write_page_reg(phydev, 3, LAN8814_EEE_WAKE_TX_TIMER,
	...
	/* PLL trim */
	val = lan8814_read_page_reg(phydev, 29, LAN8814_ANALOG_CONTROL_1);
	val |= (LAN8814_ANALOG_CONTROL_1_PLL_TRIM << 5);
	lan8814_write_page_reg(phydev, 29, LAN8814_ANALOG_CONTROL_1, val);

	val = lan8814_read_page_reg(phydev, 29, LAN8814_ANALOG_CONTROL_10);
	val &= ~LAN8814_ANALOG_CONTROL_10_PLL_DIV_MASK;
	val |= LAN8814_ANALOG_CONTROL_10_PLL_DIV;
	lan8814_write_page_reg(phydev, 29, LAN8814_ANALOG_CONTROL_10, val);
...
static int lan8814_config_ts_intr(struct phy_device *phydev, bool enable)
{
	...
	return lan8814_write_page_reg(phydev, 5, PTP_TSU_INT_EN, val);
}
...
static void lan8814_get_latency(struct phy_device *phydev)
{
	...
	latencies->rx_1000 = lan8814_read_page_reg(phydev, 5, PTP_RX_LATENCY_1000);
	latencies->rx_100 = lan8814_read_page_reg(phydev, 5, PTP_RX_LATENCY_100);
	latencies->rx_10 = lan8814_read_page_reg(phydev, 5, PTP_RX_LATENCY_10);
	latencies->tx_1000 = lan8814_read_page_reg(phydev, 5, PTP_TX_LATENCY_1000);
	latencies->tx_100 = lan8814_read_page_reg(phydev, 5, PTP_TX_LATENCY_100);
	latencies->tx_10 = lan8814_read_page_reg(phydev, 5, PTP_TX_LATENCY_10);
}
				   ...
				   struct kszphy_latencies *latencies)
{
	switch (phydev->speed) {
	case SPEED_1000:
		lan8814_write_page_reg(phydev, 5, PTP_RX_LATENCY_1000,
				       latencies->rx_1000);
		lan8814_write_page_reg(phydev, 5, PTP_TX_LATENCY_1000,
				       latencies->tx_1000);
		break;
	case SPEED_100:
		lan8814_write_page_reg(phydev, 5, PTP_RX_LATENCY_100,
				       latencies->rx_100);
		lan8814_write_page_reg(phydev, 5, PTP_TX_LATENCY_100,
				       latencies->tx_100);
		break;
	case SPEED_10:
		lan8814_write_page_reg(phydev, 5, PTP_RX_LATENCY_10,
				       latencies->rx_10);
		lan8814_write_page_reg(phydev, 5, PTP_TX_LATENCY_10,
				       latencies->tx_10);
		break;
	default:
		break;
...
static int lan8814_hwtstamp(struct mii_timestamper *mii_ts, struct ifreq *ifr)
{
	...
	lan8814_write_page_reg(ptp_priv->phydev, 5, PTP_RX_PARSE_CONFIG, rxcfg);
	lan8814_write_page_reg(ptp_priv->phydev, 5, PTP_TX_PARSE_CONFIG, txcfg);

	pkt_ts_enable = PTP_TIMESTAMP_EN_SYNC_ | PTP_TIMESTAMP_EN_DREQ_ |
			PTP_TIMESTAMP_EN_PDREQ_ | PTP_TIMESTAMP_EN_PDRES_;
	lan8814_write_page_reg(ptp_priv->phydev, 5, PTP_RX_TIMESTAMP_EN, pkt_ts_enable);
	lan8814_write_page_reg(ptp_priv->phydev, 5, PTP_TX_TIMESTAMP_EN, pkt_ts_enable);
	...
	lan8814_write_page_reg(ptp_priv->phydev, 5, PTP_TX_MOD, temp);
...
static void lan8814_gpio_release(struct lan8814_shared_priv *shared, s8 gpio_pin)
{
	...
	val = lan8814_read_page_reg(phydev, 4, LAN8814_GPIO_EN_ADDR(gpio_pin));
	val |= LAN8814_GPIO_EN_BIT_(gpio_pin);
	lan8814_write_page_reg(phydev, 4, LAN8814_GPIO_EN_ADDR(gpio_pin), val);

	val = lan8814_read_page_reg(phydev, 4, LAN8814_GPIO_DIR_ADDR(gpio_pin));
	val &= ~LAN8814_GPIO_DIR_BIT_(gpio_pin);
	lan8814_write_page_reg(phydev, 4, LAN8814_GPIO_DIR_ADDR(gpio_pin), val);

	val = lan8814_read_page_reg(phydev, 4, LAN8814_GPIO_BUF_ADDR(gpio_pin));
	val &= ~LAN8814_GPIO_BUF_BIT_(gpio_pin);
	lan8814_write_page_reg(phydev, 4, LAN8814_GPIO_BUF_ADDR(gpio_pin), val);
}
...
static void lan8814_gpio_init(struct lan8814_shared_priv *shared)
{
	...
	lan8814_write_page_reg(phydev, 4, LAN8814_GPIO_DIR1, 0);
	lan8814_write_page_reg(phydev, 4, LAN8814_GPIO_DIR2, 0);
	lan8814_write_page_reg(phydev, 4, LAN8814_GPIO_EN1, 0);

	/* By default disabling alternate function to GPIO 0 and 1
	 * i.e., 1: select as gpio, 0: select alt func
	 */
	lan8814_write_page_reg(phydev, 4, LAN8814_GPIO_EN2, 0x3);
	lan8814_write_page_reg(phydev, 4, LAN8814_GPIO_BUF1, 0);
	lan8814_write_page_reg(phydev, 4, LAN8814_GPIO_BUF2, 0);
}
				     ...
				     s64 start_sec, u32 start_nsec)
{
	...
	/* Set the start time */
	lan8814_write_page_reg(phydev, 4, LAN8814_PTP_CLOCK_TARGET_SEC_LO_X(gpio_pin),
			       lower_16_bits(start_sec));
	lan8814_write_page_reg(phydev, 4, LAN8814_PTP_CLOCK_TARGET_SEC_HI_X(gpio_pin),
			       upper_16_bits(start_sec));

	lan8814_write_page_reg(phydev, 4, LAN8814_PTP_CLOCK_TARGET_NS_LO_X(gpio_pin),
			       lower_16_bits(start_nsec));
	lan8814_write_page_reg(phydev, 4, LAN8814_PTP_CLOCK_TARGET_NS_HI_X(gpio_pin),
...
{
	lan8814_write_page_reg(phydev, 4, LAN8814_PTP_CLOCK_TARGET_RELOAD_SEC_LO_X(gpio_pin),
			       lower_16_bits(period_sec));
	lan8814_write_page_reg(phydev, 4, LAN8814_PTP_CLOCK_TARGET_RELOAD_SEC_HI_X(gpio_pin),
			       upper_16_bits(period_sec));

	lan8814_write_page_reg(phydev, 4, LAN8814_PTP_CLOCK_TARGET_RELOAD_NS_LO_X(gpio_pin),
			       lower_16_bits(period_nsec));
	lan8814_write_page_reg(phydev, 4, LAN8814_PTP_CLOCK_TARGET_RELOAD_NS_HI_X(gpio_pin),
...
static void lan8814_general_event_config(struct phy_device *phydev, s8 gpio_pin, int pulse_width)
{
	...
	general_config = lan8814_read_page_reg(phydev, 4, LAN8814_PTP_GENERAL_CONFIG);
	...
	lan8814_write_page_reg(phydev, 4, LAN8814_PTP_GENERAL_CONFIG, general_config);
}
...
static int lan8814_ptpci_adjfine(struct ptp_clock_info *ptpci, long scaled_ppm)
{
	...
	mutex_lock(&shared->shared_lock);
	lan8814_write_page_reg(phydev, 4, PTP_CLOCK_RATE_ADJ_HI, kszphy_rate_adj_hi);
	lan8814_write_page_reg(phydev, 4, PTP_CLOCK_RATE_ADJ_LO, kszphy_rate_adj_lo);
	mutex_unlock(&shared->shared_lock);
...
static void lan8814_handle_ptp_interrupt(struct phy_device *phydev)
{
	...
	status = lan8814_read_page_reg(phydev, 5, PTP_TSU_INT_STS);
...
static irqreturn_t lan8814_handle_interrupt(struct phy_device *phydev)
{
	...
	while (1) {
		tsu_irq_status = lan8814_read_page_reg(phydev, 4,
...
static int lan8804_config_init(struct phy_device *phydev)
{
	...
	/* Enable fix latency */
	lan8814_write_page_reg(phydev, 2, LAN8814_LATENCY_ENABLE, 0x1);

	/* Make sure that the PHY will not stop generating the clock when the
	 * link partner goes down
	 */
	lan8814_write_page_reg(phydev, 31, LAN8814_CLOCK_MANAGEMENT, 0x27e);
	lan8814_read_page_reg(phydev, 1, LAN8814_LINK_QUALITY);
...
static void lan8814_ptp_init(struct phy_device *phydev)
{
	...
	temp = lan8814_read_page_reg(phydev, 5, PTP_RX_MOD);
	temp |= PTP_RX_MOD_BAD_UDPV4_CHKSUM_FORCE_FCS_DIS_;
	lan8814_write_page_reg(phydev, 5, PTP_RX_MOD, temp);

	lan8814_write_page_reg(phydev, 5, PTP_RX_PARSE_CONFIG, 0);
	lan8814_write_page_reg(phydev, 5, PTP_TX_PARSE_CONFIG, 0);

	/* Removing default registers configs related to L2 and IP */
	lan8814_write_page_reg(phydev, 5, PTP_TX_PARSE_L2_ADDR_EN, 0);
	lan8814_write_page_reg(phydev, 5, PTP_RX_PARSE_L2_ADDR_EN, 0);
	lan8814_write_page_reg(phydev, 5, PTP_TX_PARSE_IP_ADDR_EN, 0);
	lan8814_write_page_reg(phydev, 5, PTP_RX_PARSE_IP_ADDR_EN, 0);
...
static void lan8814_workarounds_in_probe(struct phy_device *phydev)
{
	...
	val = lan8814_read_page_reg(phydev, 1, LAN8814_PD_CONTROLS);
	val &= ~LAN8814_PD_CONTROLS_PD_MEAS_TIME_MASK_;
	val |= LAN8814_PD_CONTROLS_PD_MEAS_TIME_VAL_;
	lan8814_write_page_reg(phydev, 1, LAN8814_PD_CONTROLS, val);

	val = lan8814_read_page_reg(phydev, 1, LAN8814_DFE_INIT2_100);
	val &= ~LAN8814_DFE_INIT2_100_DEVICE_ERE_MASK_;
	val |= (LAN8814_DFE_INIT2_100_DEVICE_ERE_VAL_ << 9);
	lan8814_write_page_reg(phydev, 1, LAN8814_DFE_INIT2_100, val);
	 ...
	 */
	lan8814_write_page_reg(phydev, 1, LAN8814_PGA_TABLE_1G_ENTRY_0, 0x10a);
	lan8814_write_page_reg(phydev, 1, LAN8814_PGA_TABLE_1G_ENTRY_1, 0xed);
	lan8814_write_page_reg(phydev, 1, LAN8814_PGA_TABLE_1G_ENTRY_2, 0xd3);
	lan8814_write_page_reg(phydev, 1, LAN8814_PGA_TABLE_1G_ENTRY_3, 0xbc);
	lan8814_write_page_reg(phydev, 1, LAN8814_PGA_TABLE_1G_ENTRY_4, 0xa8);
	lan8814_write_page_reg(phydev, 1, LAN8814_PGA_TABLE_1G_ENTRY_5, 0x96);
	lan8814_write_page_reg(phydev, 1, LAN8814_PGA_TABLE_1G_ENTRY_6, 0x85);
	lan8814_write_page_reg(phydev, 1, LAN8814_PGA_TABLE_1G_ENTRY_7, 0x77);
	lan8814_write_page_reg(phydev, 1, LAN8814_PGA_TABLE_1G_ENTRY_8, 0x6a);
	lan8814_write_page_reg(phydev, 1, LAN8814_PGA_TABLE_1G_ENTRY_9, 0x5e);
	lan8814_write_page_reg(phydev, 1, LAN8814_PGA_TABLE_1G_ENTRY_10, 0x54);
	lan8814_write_page_reg(phydev, 1, LAN8814_PGA_TABLE_1G_ENTRY_11, 0x4b);
	lan8814_write_page_reg(phydev, 1, LAN8814_PGA_TABLE_1G_ENTRY_12, 0x43);
	lan8814_write_page_reg(phydev, 1, LAN8814_PGA_TABLE_1G_ENTRY_13, 0x3c);
	lan8814_write_page_reg(phydev, 1, LAN8814_PGA_TABLE_1G_ENTRY_14, 0x35);
	lan8814_write_page_reg(phydev, 1, LAN8814_PGA_TABLE_1G_ENTRY_15, 0x2f);
	lan8814_write_page_reg(phydev, 1, LAN8814_PGA_TABLE_1G_ENTRY_16, 0x2a);
	lan8814_write_page_reg(phydev, 1, LAN8814_PGA_TABLE_1G_ENTRY_17, 0x26);

	/* work-around for rev A */
	if (priv->rev < 1) {
		val = lan8814_read_page_reg(phydev, 2, LAN8814_OPERATION_MODE_STRAP_LOW);
		val |= LAN8814_OPERATION_MODE_STRAP_LOW_GMII_MODE_;
		lan8814_write_page_reg(phydev, 2, LAN8814_OPERATION_MODE_STRAP_LOW, val);

		val = lan8814_read_page_reg(phydev, 2, LAN8814_OPERATION_MODE_STRAP_HIGH);
		...
		lan8814_write_page_reg(phydev, 2, LAN8814_OPERATION_MODE_STRAP_HIGH, val);
	}
}
...
static struct phy_driver ksphy_driver[] = {
{
	...
	.phy_id_mask	= MICREL_PHY_ID_MASK,
	.name		= "Microchip INDY Gigabit Internal",
