...
------------------------------------- 
	...
	Copy and overwrite linux-5.4.224/drivers/net/ethernet/microchip/lan743x_main.h
	Copy and overwrite linux-5.4.224/drivers/net/ethernet/microchip/lan743x_main.c
	Copy and overwrite linux-5.4.224/include/linux/micrel_phy.h
	Copy and overwrite linux-5.4.224/drivers/net/phy/micrel.c
        Delete object files if that exists.
          rm drivers/net/ethernet/microchip/lan743x_main.o
          rm drivers/net/phy/micrel.o
    c. Compile drivers at the root of your linux-5.4.224 source tree.
...
5.  Release history 
-------------------
    v1.0 (public release) 2/14/2023 - internal release on 12/19/2022
    Basic features only.
